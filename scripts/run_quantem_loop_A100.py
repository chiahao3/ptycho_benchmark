...
from scripts.diagnostics import print_system_info # Local script in ptycho_benchmark/scripts
            ...
            for pmode in [1,3,6,12]:
                for slice in [1,3,6,12]:
                    try:
                        ...
                        output_dir = f"output/tBL_WSe2/20260309_quantem_A100_table_r{str(round_idx)}/b{batch}_p{pmode}_{slice}slice/"
