...
# CONFIGURATION
# ==========================================
PACKAGE_NAME="ptyrad" # Change this to phaser or quantem for the other scripts
...
if [ "$LOCAL" = true ]; then
    ...
    pip install "git+https://github.com/chiahao3/ptyrad.git@${GIT_REF}"
