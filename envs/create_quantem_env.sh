...
# CONFIGURATION
# ==========================================
PACKAGE_NAME="quantem" # Change this to phaser or quantem for the other scripts
...
if [ "$LOCAL" = true ]; then
    ...
    pip install "git+https://github.com/electronmicroscopy/quantem.git@${GIT_REF}"
